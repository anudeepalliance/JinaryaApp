//package com.example.android.jinarya.Questions.DummyQuestionPapers;
//
...
//
///**
// * Created by Aadhyamo on 25/02/18.
// */
//
//public class DummyQuestionPaper {
//
//    //no constructor so a default constructor will be called by android studio
//
//    //female Questions
//    public static QuestionsAndOptions DQPFQ1 = new QuestionsAndOptions(
...
//
//
//    public static QuestionsAndOptions DQPFQ2 = new QuestionsAndOptions(
...
//
//    public static QuestionsAndOptions DQPFQ3 = new QuestionsAndOptions(
...
//        QuestionPaper5FemaleQuestions.add(DQPFQ1);
//        QuestionPaper5FemaleQuestions.add(DQPFQ2);
//        QuestionPaper5FemaleQuestions.add(DQPFQ3);
//
...
//
//    // male Questions
//    public static QuestionsAndOptions DQPMQ1 = new QuestionsAndOptions(
//            "Pick a color that matches you",
//            new Option("blue", "A"),
//            new Option("red", "B"),
//            new Option("green", "C"),
...
//            R.drawable.ic_happy);
//
//    public static QuestionsAndOptions DQPMQ2 = new QuestionsAndOptions(
//            "Pick a vacation spot that matches you",
//            new Option("Greece", "A"),
//            new Option("Italy", "B"),
//            new Option("Switzerland", "C"),
...
//            R.drawable.ic_house);
//
//    public static QuestionsAndOptions DQPMQ3 = new QuestionsAndOptions(
//            "Pick a movie spot that matches you",
//            new Option("dil", "A"),
//            new Option("karma", "B"),
//            new Option("swat", "C"),
...
//        QuestionPaper5MaleQuestions.add(DQPMQ1);
//        QuestionPaper5MaleQuestions.add(DQPMQ2);
//        QuestionPaper5MaleQuestions.add(DQPMQ3);
//
...
//
//
//    public static ReportObject calculateDummyQuestionsPaper5Results
//            (String boyName,
//             String girlName,
...
//
//        ReportObject dummyQuestionPaperReportObject = new ReportObject(boyName, girlName,
//                resultSummary, compatibilityScore, compatibilityScoreFeedback, adviceSummary);
//
//        return dummyQuestionPaperReportObject;
//    }
//
//}
