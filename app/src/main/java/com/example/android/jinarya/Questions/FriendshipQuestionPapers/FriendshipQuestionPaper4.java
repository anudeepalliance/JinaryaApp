...
// */
//
//public class FriendshipQuestionPaper4 {
//
//    //no constructor so a default constructor will be called by android studio
//
//    //female Questions
//    public static QuestionsAndOptions FQP4FQ1 = new QuestionsAndOptions(
...
//
//
//    public static QuestionsAndOptions FQP4FQ2 = new QuestionsAndOptions(
...
//
//    public static QuestionsAndOptions FQP4FQ3 = new QuestionsAndOptions(
...
//
//
//    public static ArrayList<QuestionsAndOptions> FQP4GirlQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper4FemaleQuestions= new ArrayList<>();
//        QuestionPaper4FemaleQuestions.add(FQP4FQ1);
//        QuestionPaper4FemaleQuestions.add(FQP4FQ2);
//        QuestionPaper4FemaleQuestions.add(FQP4FQ3);
//
...
//
//    // male Questions
//    public static QuestionsAndOptions FQP4MQ1 = new QuestionsAndOptions(
//            "Pick a color that matches you",
//            new Option("blue", "A"),
//            new Option("red", "B"),
//            new Option("green", "C"),
...
//            R.drawable.ic_happy);
//
//    public static QuestionsAndOptions FQP4MQ2 = new QuestionsAndOptions(
//            "Pick a vacation spot that matches you",
//            new Option("Greece", "A"),
//            new Option("Italy", "B"),
//            new Option("Switzerland", "C"),
...
//            R.drawable.ic_house);
//
//    public static QuestionsAndOptions FQP4MQ3 = new QuestionsAndOptions(
//            "Pick a movie spot that matches you",
//            new Option("dil", "A"),
//            new Option("karma", "B"),
//            new Option("swat", "C"),
...
//            R.drawable.ic_love);
//
//    public static ArrayList<QuestionsAndOptions> FQP4BoyQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper4MaleQuestions = new ArrayList<>();
//        QuestionPaper4MaleQuestions.add(FQP4MQ1);
//        QuestionPaper4MaleQuestions.add(FQP4MQ2);
//        QuestionPaper4MaleQuestions.add(FQP4MQ3);
//
...
//
//
//    public static ReportObject calculateFriendshipQuestionsPaper4Results
//            (String boyName,
//             String girlName,
...
//
//        ReportObject friendshipQuestionPaper4ReportObject = new ReportObject(boyName, girlName,
//                resultSummary, compatibilityScore, compatibilityScoreFeedback, adviceSummary);
//
//        return friendshipQuestionPaper4ReportObject;
//    }
//
//}
