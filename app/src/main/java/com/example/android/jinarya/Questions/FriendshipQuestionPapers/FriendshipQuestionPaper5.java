...
// */
//
//public class FriendshipQuestionPaper5 {
//
//    //no constructor so a default constructor will be called by android studio
//
//    //female Questions
//    public static QuestionsAndOptions FQP5FQ1 = new QuestionsAndOptions(
...
//
//
//    public static QuestionsAndOptions FQP5FQ2 = new QuestionsAndOptions(
...
//
//    public static QuestionsAndOptions FQP5FQ3 = new QuestionsAndOptions(
...
//
//
//    public static ArrayList<QuestionsAndOptions> FQP5GirlQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper5FemaleQuestions= new ArrayList<>();
//        QuestionPaper5FemaleQuestions.add(FQP5FQ1);
//        QuestionPaper5FemaleQuestions.add(FQP5FQ2);
//        QuestionPaper5FemaleQuestions.add(FQP5FQ3);
//
...
//
//    // male Questions
//    public static QuestionsAndOptions FQP5MQ1 = new QuestionsAndOptions(
//            "Pick a color that matches you",
//            new Option("blue", "A"),
//            new Option("red", "B"),
//            new Option("green", "C"),
...
//            R.drawable.ic_happy);
//
//    public static QuestionsAndOptions FQP5MQ2 = new QuestionsAndOptions(
//            "Pick a vacation spot that matches you",
//            new Option("Greece", "A"),
//            new Option("Italy", "B"),
//            new Option("Switzerland", "C"),
...
//            R.drawable.ic_house);
//
//    public static QuestionsAndOptions FQP5MQ3 = new QuestionsAndOptions(
//            "Pick a movie spot that matches you",
//            new Option("dil", "A"),
//            new Option("karma", "B"),
//            new Option("swat", "C"),
...
//            R.drawable.ic_love);
//
//    public static ArrayList<QuestionsAndOptions> FQP5BoyQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper5MaleQuestions = new ArrayList<>();
//        QuestionPaper5MaleQuestions.add(FQP5MQ1);
//        QuestionPaper5MaleQuestions.add(FQP5MQ2);
//        QuestionPaper5MaleQuestions.add(FQP5MQ3);
//
...
//
//
//    public static ReportObject calculateFriendshipQuestionsPaper5Results
//            (String boyName,
//             String girlName,
...
//
//        ReportObject friendshipQuestionPaper5ReportObject = new ReportObject(boyName, girlName,
//                resultSummary, compatibilityScore, compatibilityScoreFeedback, adviceSummary);
//
//        return friendshipQuestionPaper5ReportObject;
//    }
//
//}
//
