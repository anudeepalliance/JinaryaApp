...
// */
//
//public class FriendshipQuestionPaper2 {
//
//    //no constructor so a default constructor will be called by android studio
//
//    //female Questions
//    public static QuestionsAndOptions FQP2FQ1 = new QuestionsAndOptions(
...
//
//
//    public static QuestionsAndOptions FQP2FQ2 = new QuestionsAndOptions(
...
//
//
//    public static ArrayList<QuestionsAndOptions> FQP2GirlQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper2FemaleQuestions= new ArrayList<>();
//        QuestionPaper2FemaleQuestions.add(FQP2FQ1);
//        QuestionPaper2FemaleQuestions.add(FQP2FQ2);
//        QuestionPaper2FemaleQuestions.add(FQP3FQ3);
//
...
//
//    // male Questions
//    public static QuestionsAndOptions FQP2MQ1 = new QuestionsAndOptions(
//            "Pick a color that matches you",
//            new Option("blue", "A"),
//            new Option("red", "B"),
//            new Option("green", "C"),
...
//            R.drawable.ic_happy);
//
//    public static QuestionsAndOptions FQP2MQ2 = new QuestionsAndOptions(
//            "Pick a vacation spot that matches you",
//            new Option("Greece", "A"),
//            new Option("Italy", "B"),
//            new Option("Switzerland", "C"),
...
//            R.drawable.ic_house);
//
//    public static QuestionsAndOptions FQP2MQ3 = new QuestionsAndOptions(
//            "Pick a movie spot that matches you",
//            new Option("dil", "A"),
//            new Option("karma", "B"),
//            new Option("swat", "C"),
...
//            R.drawable.ic_love);
//
//    public static ArrayList<QuestionsAndOptions> FQP2BoyQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper2MaleQuestions = new ArrayList<>();
//        QuestionPaper2MaleQuestions.add(FQP2MQ1);
//        QuestionPaper2MaleQuestions.add(FQP2MQ2);
//        QuestionPaper2MaleQuestions.add(FQP2MQ3);
//
...
//
//
//    public static ReportObject calculateFriendshipQuestionsPaper2Results
//            (String boyName,
//             String girlName,
...
//
//        ReportObject friendshipQuestionPaper2ReportObject = new ReportObject(boyName, girlName,
//                resultSummary, compatibilityScore,compatibilityScoreFeedback, adviceSummary);
//
//        return friendshipQuestionPaper2ReportObject;
//    }
//
//}
