...
// */
//
//public class RelationshipQuestionPaper3  {
//
//    //no constructor so a default constructor will be called by android studio
//
//    //female Questions
//    public static QuestionsAndOptions RQP3FQ1 = new QuestionsAndOptions(
...
//
//
//    public static QuestionsAndOptions RQP3FQ2 = new QuestionsAndOptions(
...
//
//
//    public static ArrayList<QuestionsAndOptions> RQP3GirlQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper3FemaleQuestions= new ArrayList<>();
//        QuestionPaper3FemaleQuestions.add(RQP3FQ1);
//        QuestionPaper3FemaleQuestions.add(RQP3FQ2);
//        QuestionPaper3FemaleQuestions.add(RQP3FQ3);
//
...
//
//    // male Questions
//    public static QuestionsAndOptions RQP3MQ1 = new QuestionsAndOptions(
//            "Pick a color that matches you",
//            new Option("blue", "A"),
//            new Option("red", "B"),
//            new Option("green", "C"),
...
//            R.drawable.ic_happy);
//
//    public static QuestionsAndOptions RQP3MQ2 = new QuestionsAndOptions(
//            "Pick a vacation spot that matches you",
//            new Option("Greece", "A"),
//            new Option("Italy", "B"),
//            new Option("Switzerland", "C"),
...
//            R.drawable.ic_house);
//
//    public static QuestionsAndOptions RQP3MQ3 = new QuestionsAndOptions(
//            "Pick a movie spot that matches you",
//            new Option("dil", "A"),
//            new Option("karma", "B"),
//            new Option("swat", "C"),
...
//            R.drawable.ic_love);
//
//    public static ArrayList<QuestionsAndOptions> RQP3BoyQuestions() {
//
//        ArrayList<QuestionsAndOptions> QuestionPaper3MaleQuestions = new ArrayList<>();
//        QuestionPaper3MaleQuestions.add(RQP3MQ1);
//        QuestionPaper3MaleQuestions.add(RQP3MQ2);
//        QuestionPaper3MaleQuestions.add(RQP3MQ3);
//
...
//
//
//    public static ReportObject calculateRelationshipQuestionsPaper3Results
//            (String boyName,
//             String girlName,
...
//
//        ReportObject relationshipQuestionPaper3ReportObject = new ReportObject(boyName, girlName,
//                resultSummary, compatibilityScore, compatibilityScoreFeedback, adviceSummary);
//
//        return relationshipQuestionPaper3ReportObject;
//    }
//
//}
